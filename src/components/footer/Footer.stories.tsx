...
export const WithLink = (props: FooterProps) => (
  <Footer
    {...props}
    info={{
      name: "KITS AB",
    ...
    link={{
      text: "Whistleblowing",
      url: "https://visselblas.se/kits"
    }}
  />
)

export const WithContactLink = (props: FooterProps) => (
  <Footer
    {...props}
    info={{
      name: "KITS AB",
...
export const WithSelfTargetLink = (props: FooterProps) => (
  <Footer
    {...props}
    info={{
      name: "KITS AB",
